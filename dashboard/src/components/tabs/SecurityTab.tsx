            ...
            <div className="security-row">
              ...
              <span className="security-value">
                {upd.last_update_time
                  ? new Date(upd.last_update_time).toLocaleDateString(undefined, {
                      year: 'numeric',
                      month: 'short',
                      day: 'numeric',
                    })
            ...
            <div className="security-row">
              ...
              <span
                className={`security-value ${
                  upd.pending_count > 0 ? 'text-warning' : 'text-success'
                }`}
              >
            ...
            {upd.pending_updates && upd.pending_updates.length > 0 && (
              <div className="pending-list">
                ...
                {upd.pending_updates.length > 5 && (
                  <div className="pending-item muted">
                    +{upd.pending_updates.length - 5} more
                  </div>
                )}
              </div>
            )}
